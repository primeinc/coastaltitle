      ...
      caseData: [
        {
          idx: 0,
          bg: imgAPI.office[0],
          title: this.$t('caseData.0.title'),
          desc: this.$t('caseData.0.description'),
          size: 'small',
          simple: false,
        },
        {
          idx: 1,
          bg: imgAPI.office[2],
          title: this.$t('caseData.1.title'),
          desc: this.$t('caseData.1.description'),
          size: 'small',
          simple: false,
        },
        {
          idx: 2,
          bg: imgAPI.office[4],
          title: this.$t('caseData.2.title'),
          desc: this.$t('caseData.2.description'),
          size: 'medium',
          simple: false,
        },
        {
          idx: 3,
          bg: imgAPI.office[6],
          title: this.$t('caseData.3.title'),
          desc: this.$t('caseData.3.description'),
          size: 'small',
        },
        {
          idx: 5,
          bg: imgAPI.office[9],
          title: this.$t('caseData.5.title'),
          desc: this.$t('caseData.5.description'),
          size: 'medium',
        },
        {
          idx: 6,
          bg: imgAPI.office[11],
          title: this.$t('caseData.6.title'),
          desc: this.$t('caseData.6.description'),
          size: 'big',
        },
      ],
